...
//nabiji 1
let player1Bag = new Set(["Bloodthorn", "Water", "Glowspore"]);
let player2Bag = new Set(["Glowspore", "FireEssence", "Water"]);

function createGuildStash(bag1, bag2){
    return new Set([...bag1, ...bag2]);
}
console.log(createGuildStash(player1Bag,player2Bag));
...
let staash = new Set(["Water", "Bloodthorn", "Crystal"]);

console.log(canCraft(healthPotionRecipe,staash));
...
let recipe = new Set(["Water", "Crystal"]);
let stash = new Set(["Water", "Glowspore"]);

console.log(getMissingIngredients(recipe, stash));
...
let bag1 = new Set(["Water", "Bloodthorn", "Glowspore"]);
let bag2 = new Set(["Glowspore", "Crystal"]);

console.log(getTradeableItems(bag1, bag2));
