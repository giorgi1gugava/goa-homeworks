#თქვენ დაგპატიჟეს პატარა ბავშვის დაბადების დღეზე გასართობ ცენტრში, თქვენთან ერთად ამ გასართობ ცენტრში დაპატიჟეს
...
kid = input("nikoloz gaixade fexsacmelebi da qurtuki? :")

if kid == "ki" or kid == "gavixade":
    print("kargi segizlia tamasi")

else:
    print("vegar itamaseb")